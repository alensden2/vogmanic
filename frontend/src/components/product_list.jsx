 ...
 *
 * This component displays a list of products with filtering and search options.
 * It includes a sidebar with category filters, a search bar, and a grid of products.
 * Users can add products to their cart or wishlist.
 *
 * @returns {React Component} - The rendered product list component.
 */
...
// Create a custom theme using MUI's ThemeProvider
...
const ProductList = () => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch(`${HOSTED_BASE_URL}/products}`, {
          method: 'POST',
          headers: {
